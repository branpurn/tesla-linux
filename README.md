...
Flash the same `tesla-linux-YYYYMMDD-pi.img.xz` with Raspberry Pi Imager → **Use custom** onto an SD card **or** a USB stick/SSD. Do not invent a second image or a bake flag. Do not rebake.
